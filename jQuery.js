...
$('#new').find('ul') // выберет все ul которые находятся внутри #new может искать глубже чем children

$('#new').removeAttr('style'); //удаляет атрибут style

$('.child', $('.root')[0]); // использование контекста не облегчит поиск
$('.root').find('.child'); // а зачем нам перебор всех элементов внутри .root?
$('.root').children('.child'); // самый правильный вариант поиска внутри .root
